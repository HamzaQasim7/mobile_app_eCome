          ...
          if (state is RazorStateLoading) {
            ...
            if (state is RazorStateError) {
              ...
              Navigator.pushNamed(context, RouteNames.razorpayScreen,
                  arguments:
                      RemoteUrls.payWithRazorpayWeb(token ?? '', params));
            ...
            Visibility(
              ...
              child: PaymentCard(
                ...
                press: () {
                  ...
                  Navigator.pushNamed(context, RouteNames.paypalScreen,
                      arguments:
                          RemoteUrls.payWithPaypalWeb(token ?? '', params));
                },
              ),
            ),
            Visibility(
              ...
              child: PaymentCard(
                ...
                press: () {
                  ...
                  Navigator.pushNamed(context, RouteNames.flutterWaveScreen,
                      arguments:
                          RemoteUrls.payWithFlutterWave(token ?? '', params));
                },
              ),
            ),
            Visibility(
              ...
              child: PaymentCard(
                ...
                press: () async {
                  ...
                  Navigator.pushNamed(context, RouteNames.molliePaymentScreen,
                          arguments:
                              RemoteUrls.payWithMollieWeb(token ?? '', params))
                      .then((value) {
                    if (value == true) {
                      Navigator.pushNamedAndRemoveUntil(
                          context, RouteNames.orderScreen, (route) {
              ...
              child: PaymentCard(
                ...
                press: () async {
                  ...
                  Navigator.pushNamed(
                          ...
                          arguments: RemoteUrls.payWithMyFatooraheWeb(
                              token ?? '', params))
                      .then((value) {
                    if (value == true) {
                      Navigator.pushNamedAndRemoveUntil(
              ...
              child: PaymentCard(
                ...
                press: () {
                  ...
                  Navigator.pushNamed(
                      ...
                      arguments:
                          RemoteUrls.payWithInstaMojoWeb(token ?? '', params));
                },
              ),
            ),
            Visibility(
              ...
              child: PaymentCard(
                ...
                press: () {
                  ...
                  Navigator.pushNamed(context, RouteNames.paystackPaymentScreen,
                      arguments:
                          RemoteUrls.payWithPayStackWeb(token ?? '', params));
                },
              ),
            ),
            Visibility(
              ...
              child: PaymentCard(
                ...
                press: () {
                  ...
                  Navigator.pushNamed(context, RouteNames.sslCommerceScreen,
                      arguments:
                          RemoteUrls.payWithSslCommerz(token ?? '', params));
                },
              ),
            ),
            Visibility(
